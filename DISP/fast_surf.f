...
c     *d_ref(nsize),qs_ref(nsize)
	...
	real*4 	uL0(nper), uR0(nper), cL0(nper), cR0(nper),
     &rR0(nper), rL0(nper), ugr0(nper), ampl0(nper)
...
c !$OMP THREADPRIVATE (/d/,/numbers/,/o/,/c/,/newly/,/rar/,/rar1/,/rco/)
c !$OMP THREADPRIVATE (/rco1/,/derivd/, /log/, /ref/, /surfr/, /dispe/)
c !$OMP THREADPRIVATE (/dispe1/, /surf_com/)
...
c	   write (*,*) a_ref0(i), b_ref0(i), d_ref0(i),n_layer
	   ...
	   qs_ref(i) = qs_ref0(i)
	   d_ref(i) = d_ref0(i)
c           write (*,*) 'in here', a_ref(i), b_ref(i), rho_ref(i), qs_ref(i), d_ref(i)
c     c , d_ref(i)
c           write(*,*) n_layer
	enddo
c        do i = 1,ncvper
